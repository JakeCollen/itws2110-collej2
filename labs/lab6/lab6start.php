...
// Instead of using ifs, this could be done by creating a list that links the name of the button to the class object it should create.
// For example, $operations = ['Add' => Addition::class, 'Subtract' => Subtraction::class, 'Multiply' => Multiplication::class, 'Divide' => Division::class]
// Then given a value from the form, the list can be searched for what class object should be created
